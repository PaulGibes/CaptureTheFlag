    ...
    <>
      <section className="min-h-screen">
        ...
        <div className="text-center flex md:gap-10 lg:gap-30 justify-center items-center ">
          <div className=" ">
            <p className="text-2xl md:text-5xl p-4 mt-8 text-white">
              The Outsiders
            </p>
          </div>
          <div className=" ">
          ...
          <div className="flex flex-col  justify-center ">
            <p className="text-2xl md:text-5xl p-4 mt-8 my-5 text-white">
              The Insiders
            </p>
          </div>
        </div>
        <div className="flex justify-evenly">
          {data.user.isHost ? (
            <div className="flex">
              <motion.div
                onClick={() =>
                  HandleStartGame(data.user.username, gameId, teamPlayers)
                }
